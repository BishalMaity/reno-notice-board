  ...
  useEffect(() => {
    ...
    const fetchNotice = async () => {
      try {
        ...
        setSubmitError('Failed to load notice details. Please make sure the notice ID is valid.');
      } finally {
        setLoading(false);
      }
    };
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700/60 shadow-sm p-8 md:p-10">
          ...
          <div className="mb-8 border-b border-gray-100 dark:border-slate-700 pb-6">
            ...
            <p className="mt-2 text-sm text-gray-500 dark:text-slate-400">
              Update the fields below to modify the notice on the board.
            </p>
          </div>
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-sm text-gray-500 dark:text-slate-400 font-medium">Loading notice details...</p>
            </div>
          ) : (
            /* Form */
